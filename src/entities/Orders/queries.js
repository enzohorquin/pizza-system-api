module.exports = {
    ...
    getOrders: 'SELECT o.totalAmount, o.dateOrder, p.name, po.quantity FROM orders o JOIN productinorder po ON (o.idOrder = po.idOrder) JOIN product p ON (po.idProduct = po.idProduct) WHERE o.idUser = ?',
